...
class CloudKitEncryptedRecordDecoderTests: XCTestCase {
    ...
    func testComplexPersonStructDecoding() throws {
        ...
        record.setValuesForKeys([
            ...
            "avatar": CKAsset(fileURL: URL(fileURLWithPath: "/Users/inside/Library/Containers/br.com.guilhermerambo.CloudKitRoundTrip/Data/Library/Caches/CloudKit/aa007d03cf247aebef55372fa57c05d0dc3d8682/Assets/7644AD10-A5A5-4191-B4FF-EF412CC08A52.01ec4e7f3a4fe140bcc758ae2c4a30c7bbb04de8db")),
    ...
    func testRoundTrip() throws {
        ...
        let samePersonDecoded = try CloudKitEncryptedRecordDecoder(key: key).decode(Person.self, from: encodedPerson)
    ...
    func testRoundTripWithCustomZoneID() throws {
        ...
        let encodedPerson = try CloudKitEncryptedRecordEncoder(key: key, zoneID: zoneID).encode(Person.rambo)
        let samePersonDecoded = try CloudKitEncryptedRecordDecoder(key: key).decode(Person.self, from: encodedPerson)
    ...
    func testCustomRecordIdentifierRoundTrip() throws {
        ...
        let samePersonDecoded = try CloudKitEncryptedRecordDecoder(key: key).decode(PersonWithCustomIdentifier.self, from: record)
